...
# Define the model to store user input, prediction results, and timestamp
...
def predict():
    if request.method == 'POST':
        try:
            ...
            logging.error(f"Error converting form data: {e}")
            return render_template('predict.html', error="Invalid input data")
